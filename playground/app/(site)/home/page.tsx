          ...
          <div className="cov-grid">
            <div className="cov-col ok reveal">
              ...
              <ul className="cov-list">
                <li>
                  <IcCheckSm />
                  <div><div className="cl-name">mapping, T[], structs, enums</div><div className="cl-desc">collections incl. nested mappings + dynamic arrays</div></div>
                </li>
                <li>
                  <IcCheckSm />
                  <div><div className="cl-name">modifiers, inheritance, overloading</div><div className="cl-desc">flattened via <code className="inline">is</code>, inlined as guards</div></div>
                </li>
                <li>
                  <IcCheckSm />
                  <div><div className="cl-name">checked integer arithmetic</div><div className="cl-desc">true bit-width semantics, <code className="inline">unchecked {'{}'}</code> wraps</div></div>
                </li>
                <li>
                  <IcCheckSm />
                  <div><div className="cl-name">events, payable, cross-contract</div><div className="cl-desc"><code className="inline">emit</code>, <code className="inline">msg.value</code>, <code className="inline">IFoo(addr).bar()</code></div></div>
                </li>
              </ul>
            </div>
            <div className="cov-col no reveal">
              ...
              <ul className="cov-list">
                <li>
                  <IcX />
                  <div><div className="cl-name">inline assembly</div><div className="cl-desc">no host function on the seal0 target</div></div>
                </li>
                <li>
                  <IcX />
                  <div><div className="cl-name">delegatecall, tx.origin</div><div className="cl-desc">unavailable under rent-era pallet-contracts</div></div>
                </li>
                <li>
                  <IcX />
                  <div><div className="cl-name">ternary ?:, new factory</div><div className="cl-desc">use if/else; factory deployment unsupported</div></div>
                </li>
                <li>
                  <IcX />
                  <div><div className="cl-name">libraries, abi.encodePacked</div><div className="cl-desc">flatten into the contract; use typed args</div></div>
                </li>
              </ul>
            </div>
          </div>
